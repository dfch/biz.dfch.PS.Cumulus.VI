...
Connect to the required vCenter Servers
...
BEGIN
{
	...
	# DFCHECK - what is this? and what for ?
...
try
{
	...
	{
		# DFCHECK error checking
		Log-Debug -fn $fn -msg ("Connecting to vCenter '{0}' ..." -f $Object );
		if($Credential)
		{
			$OutputParameter = Connect-VIServer -Server $Object -Credential $Credential;
		} 
		else 
		{
			$OutputParameter = Connect-VIServer -Server $Object;
		}
		$OutputParameter;
	}
}
...
{
	# DFECHECK - correct throw/catch
	Log-Error -fn $fn -msg ("Error occured in vCenter Connections" );
	throw ("Error occured in vCenter Connections" );
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUStaEndDeBCRhCGN7SQyEGJKw
# wmagghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTNEaC3uBuPnYkO8llK
# rV3fJDMjrzANBgkqhkiG9w0BAQEFAASCAQBxIWmm/VzklD2JPTx/Crmgh0KrgP9m
# rkmrlrzMFln/LYnsdGd7m4L9etS0VfQokunDe3ftROC89t9OzptoWaZ2LTMKSVAG
# jy28hImLEFr1WqhjptJQ/cz62hWG9lgAXFlXXSdRivGA8RzlpTe55EYoMvPpfF+f
# w1jh6qHz3rOb2ocMqBZ3X8veFZvENBIzbeaNqyTOtYHogP6OudZwe89GfxyC15uG
# ifPY5n89ONqy99luGKgB6mEnxUsmp+rLMktEFDBRs7NSPEdSKKmcgyzRTXVhIUoe
# /cLIHeeqgH5vCNQoST0IYHh1qwEFtuOz7hViV2Ur3FgXj1UOhLQuWST3oYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTIw
# NTA4MTQyM1owIwYJKoZIhvcNAQkEMRYEFEXcQUYPUyF1aTNCw+H8mKH/yGNkMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQARaIDjNtAE0buPjXDvvLZ6
# i3tC2+5B2AZdsVh22jcXzOZ9T79cVrKiN/xzf1qoLpSj/1ivkrsnlZqeNW+R/n6H
# 50mnnateudWa3Fao5KDbX4IdTiLUE5yqf1/tJrG9bxRan2oyDZJuMJxF6fC7kvES
# aWvaQEbAzeS/RbaDXNhNpn9cDNLGPn995mm1emGG5sBmqQ6cPHEN7bHSHEoZPXM4
# Ink/CNqF04YrB8eic4rpWbLUmVpNZsby7wm61G71kCAk9iaVZcCARkVYuh0lDmb3
# zVGBcnD1h4LHtC4i9N7DRTCxKCMK/YEvR788FIsJ3z93huPmCfj+PqoNs2sI1q6e
