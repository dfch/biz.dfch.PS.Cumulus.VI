...
( 
	...
	try
	{
				...
				$spec = New-Object VMware.Vim.VirtualMachineConfigSpec -Property @{
					"BootOptions" = New-Object VMware.Vim.VirtualMachineBootOptions -Property @{
						## set the boot order in the spec as desired
										BootOrder = $oBootableCDRom
					} ## end new-object
				} ## end new-object
		} 
		else 
		{
			## create the VirtualMachineConfigSpec with which the empty boot order
			$spec = New-Object VMware.Vim.VirtualMachineConfigSpec -Property @{
				"BootOptions" = New-Object VMware.Vim.VirtualMachineBootOptions -Property @{
					## set the boot order in the spec as desired
									BootOrder = @()
		...
		$task = $VirtualMachine.extensionData.ReconfigVM_Task($spec)
		$vitask = get-task -id  ("Task-{0}" -f $task.value)
		Wait-Task $vitask | Out-Null
		$vitask = get-task -id  ("Task-{0}" -f $task.value)
		Log-Debug -fn $fn -msg ('Task State: {0}' -f $vitask.state )
		return $true
	}
	catch
	{
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Set-VirtualMachineBootFromCD; } 


# SIG # Begin signature block
# MIIW3AYJKoZIhvcNAQcCoIIWzTCCFskCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8G1mXjncSEEaU8I3VPbO9gsB
# gXCgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBS6W9OUtRtEh9Tm+5Ko
# JHM6ez0yQzANBgkqhkiG9w0BAQEFAASCAQC9un0lcplQDol5lzMz4ojI+cyeI8QH
# JY3+ygUMPhJwzr8lMhIcvRjx/aMcRZ67Wptx3pAXonArJ0jDd1W3zstQ0kHo7xBW
# XB+HXnIErwrgBSo5oAMsj6DEECdTj+Xv/7qDk/LtP3EBsNneGilPWzpbLzMKf09Q
# FnEKEqV1oj3xJBgNSchRed+NNBh5U/OVKMsTsc0IdZ11E98hsL1BVkztAZV5P+Wl
# 2wqbLVm9OH7yM/1zc6rJu/8/xJYaVWs5/vesTBGj5MrK1Ene2ZKIm4emwXgBam+j
# CK39CzD0zJByiKQ7tYcztJwiRSfK+QHryIzZ7OeKhHNs0mtihVq9+woFoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTIw
# MzA0MTQxOFowIwYJKoZIhvcNAQkEMRYEFFr6stb62Fn6zjADvJPyEZFvcD0aMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQA1CxApWE6Wy85hosjZhNRf
# QEVMuYf/mQC/wmVEsqJ9y6xCX9Aprw7BQYlA6l4N/1B6F5Z88nr/NhgqQJlhORLn
# vT1dwpUKTXrzMuIfMfZzDONck9q+2zOMJAxB2ui9gEc8R2+hNs86ke4ZmvdTZ5CE
# qkclxH9x7lmzJtW5JI8+FO6Vjr31GM5VdwhFYLLm8DsBzWVtRLO8D98jxWA1XfbI
# ZTfKwd8SRVXLyF/rWO6drlXVmssOwaCGCDgotLbb3bHKoEqb48j3dqkj0U6uUJIy
# qLhHtQVLPsv3REME8aIkyTGn1c1ZCrgJfjbJNwikZB6PpUgKtr8AUFSUYFDb3w58
