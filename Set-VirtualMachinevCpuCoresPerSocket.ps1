...
try
{
	...
	$res = Validate-vCpuCoresPerSocket -NumCpu $NumCpu -NumCoresPerSocket $NumCoresPerSocket
	if( ( $null -eq $res) -or $false -eq $res)
	{
		$e = New-CustomErrorRecord -m 'Invalid NumCPU/NumCoresPerSocket ratio'
		throw($gotoFailure);
	}
	Log-Debug -fn $fn -msg ('Refresh VM Object {0}' -f $VM.Name )
	$VM = Get-VM $VM.Name
	if($VM.Powerstate -ne 'PoweredOff')
	{
		$e = New-CustomErrorRecord -m ( '{0} - VM should be PoweredOff to manipulate the NumCoresPerSocket Value' -f $VM.Name )
		throw($gotoFailure);
	}
	if( $VM.NumCpu -ne $NumCpu)
	{	
		Log-Debug -fn $fn -msg ('Adjust VM CPUs: {0} NumCPU: old: {1} new: {2}' -f $VM.Name, $VM.NumCpu, $NumCpu )
		$VM = $VM | Set-VM -NumCpu $NumCpu -confirm:$false;
	}
	$vmConfigSpec = New-Object -Type VMware.Vim.VirtualMachineConfigSpec -Property @{"NumCoresPerSocket" = $NumCoresPerSocket }
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Set-VirtualMachinevCpuCoresPerSocket; } 


# SIG # Begin signature block
# MIIW3AYJKoZIhvcNAQcCoIIWzTCCFskCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfUnhrHSCgHiC6jRRZv5Yn3Wl
# qg6gghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQnaaACRsaa3LxAj+jh
# pheSxVyFrjANBgkqhkiG9w0BAQEFAASCAQBu5vgfwhfvi+YwQj/ozN4uZxtd4jua
# TdDXePjeGAeKXKQumZZ1RzisxQzRvWnsNQdNNQEG6X5B0OT4EKxF/m6NDuDjM/bs
# Sk0l/dq/rI59dUHBs08NeM+WiBVEE56NPs81Y1Zn0i44RCWSPBfScA+nBv1h/GCh
# ZGa9zjvvxNFykfbwKTIRsvyI8ktSceXK8NAtnwE0J0cVENRDpVAH38WqoHX7NNcE
# EvnvG2oO0PmQsTshG5XVQ4ZFCise+bMpo3D+zdKoxvywJrp7E00HTKfgp68r1SqB
# Dg90RR47wJaGjBYivsRZ3W9TE5kui2Cb36CDh8/QKSrUYNO2W+V6vajQoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTIw
# MzA0MTQyMFowIwYJKoZIhvcNAQkEMRYEFMRZHACGWLe0rbtIG6G9kyUeGFCnMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQCtk0sfn8fl1xWi1tuR2g0A
# ZetiSsBsS0scyfIisZOEZKCp+GA6O6nQu4GF9dqOEX2yXEzDDhQOATfMHD+g0fSi
# CsngwZMlBKlKJYNM760yuo95Ybg5jq6sy1LReyj4Gm6XgAPtuO6ASBi9J7wyxFBe
# xhiGGEPg+yyulZ9cY7yYynDo5/yXEsz9S3gnZlkcvoeisJcO5O4ZYYBOqySVXa4u
# 8IpO3zLaDefv3iD9ynQeTABePC9DYFgVOwM/XwY2mnPZuqXLKKOW1nOiqmlUdJWI
# oQR+gdbY0tKEdjP4uOx1I7W+gF1EJbgK/k5QlKTjdVpp80HsEXKjtQ3NqXSH/z8u
