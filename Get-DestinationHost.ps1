...
Get target host for VM deployment
...
PARAM
(
	# Specifies the name of the cluster from which to select to the ESX host
...
{ 
	...
	$VMHost = Get-VMHost -Location $ClusterName | Where-Object { $_.ConnectionState -eq "Connected" } | Sort $_.CPuUsageMhz -Descending | Select -First 1;
	if ($VMHost -and $VMHost.GetType().name -eq "VMHostImpl")
	{
		Log-Debug -fn $fn -msg ("VMHost found: {0}" -f $VMHost.Name)
		return $VMHost
	}
	else
	{
		Log-Error -fn $fn -msg ("Error finding any VMHost in: {0}" -f $ClusterName );
		throw;
	}
} 
catch
{
	Log-Error -fn $fn -msg ("Error finding any available VMHost in: {0}" -f $ClusterName) 
	throw ("Error finding any VMHost in: {0}" -f $ClusterName )
}
} # function

if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-DestinationHost; } 


# SIG # Begin signature block
# MIIW3AYJKoZIhvcNAQcCoIIWzTCCFskCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIDaCUPg6cJMAx9GkYVnsAyjn
# 19SgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSl4aiqs24n73etmQCu
# MElm1ee9CjANBgkqhkiG9w0BAQEFAASCAQCeJNNC/E/3u2LiomzH36YZEON3ngAC
# 7vHXsZshANxepsjteTMjqYodENZkBZwKPO+NUj8djgx8ytbl+p6xm6zg1TBRhIHK
# Z69tygei1qs3HUDtgsYrrwy12TUY43HekaU/J+ttciMu37APM3E6zIkl/Cq9OgSr
# Zmks7PqdcgcS22OOYNohDX6XHOtogEHIpk1m9K1QtmsBxCiDDl7nwxlZ2bsNyckW
# U+dMATAYorXaLgcw7z+bZdH02CuwRar/eQgglpd+lzXJo1SwPAe+N2ln+QGPAlDA
# ab67K6RPyKZTX9x4OrNQeOod1NjOiaWfdmV7NCUEUsJc5s+0yr5QR2EPoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTIw
# MzA0MTQxNVowIwYJKoZIhvcNAQkEMRYEFJACWv9/LPjurhAfrwyYxn0OJWzUMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQCX8e3PRtdd8sSTnAokN1RY
# PpFqZCU/SOS9jklf+NxMeIcGMAytvVb3PyxfslThp8mQPWBE0LCn7JzgkCKmxvff
# e9zV1w4LKOND3J6hX+iSaRdwmjLNKf4oc/gDWW11dsTkGuI8Yp3535JXyDqnhZN+
# I1rS/ke9Jl0oEHInEo+VNBjUP5yaApB859aCIWgqhChsYghM49w25XMi9how5syg
# o98l70QuBmHVS1cmrrglkQOME7k6XntGKQHNiBgtRcZqw855R/g7sOjA9YGkB0v0
# /hc1mx5pVaeK6bU2gerfmdBk5SUM+gRgTYWNhmsbvXeWaowYF+UXro3D3UksJunN
