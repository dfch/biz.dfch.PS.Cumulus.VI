function Set-VirtualMachineNetworkConfiguration {
<#
.SYNOPSIS

Sets the network of a virtual machine
...
(
	...
	try {
		...
		$curNics = $VM | Get-NetworkAdapter -ea SilentlyContinue
		if( $null -ne $curNics )
		{
			$msg = ( 'VM has already NetworkAdapters configured - cowardly refusing to change current config'  );
			Log-Error -fn $fn -msg $msg
			throw $msg;
		}
		...
		{
			Log-Debug -fn $fn -msg ( 'Apply NicConfig Parameters: Type: {0} MacAddress: {1} NetworkName: {2} PortID: {3} WakeOnLan: {4} StartConnected: {5}' -f $nicConfig.NetworkAdapterType, $nicConfig.MacAddress, $nicConfig.NetworkName, $nicConfig.PortID, $nicConfig.WakeOnLan, $nicConfig.StartConnected  )

			#PortID not implemented yet
			if( !(($null -ne $nicConfig.PortID) -and ('String' -ne $nicConfig.PortID.GetType().Name ) -and ( 0 -lt $nicConfig.PortID.length )) )
			{
				$msg = ( 'Apply NicConfig on PortID or DVS not implemented yet:{0}' -f $nicConfig.PortID  );
				Log-Error -fn $fn -msg $msg
				throw $msg;
			...
			#No MacAddress?
			if( ($null -ne $nicConfig.MacAddress) -and ('String' -eq $nicConfig.MacAddress.GetType().Name ) -and ( 0 -lt $nicConfig.MacAddress.length ) )
			{
				Log-Debug -fn $fn -msg ( 'Apply NicConfig with static MacAddress: {0}' -f $nicConfig.MacAddress )
				$nic = $VM | New-NetworkAdapter -MacAddress $nicConfig.MacAddress -NetworkName $nicConfig.NetworkName -WakeOnLan:$nicConfig.WakeOnLan -StartConnected:$nicConfig.StartConnected -Type $nicConfig.NetworkAdapterType
				if( ($null -ne $nic) -and ( 'NetworkAdapterImpl' -eq $nic.GetType().Name ) )
				{
					Log-Debug -fn $fn -msg ( 'Nic successfully created: {0}' -f $nic.Name )
				
				} else {
					
					$e = New-CustomErrorRecord -m ( 'Nic creation failed: {0}' -f $Name )
					throw($gotoError);
				}
				...
				Log-Debug -fn $fn -msg ( 'Apply NicConfig with Auto MacAddress assignment' )
				$nic = $VM | New-NetworkAdapter -NetworkName $nicConfig.NetworkName -WakeOnLan:$nicConfig.WakeOnLan -StartConnected:$nicConfig.StartConnected -Type $nicConfig.NetworkAdapterType
				if( ($null -ne $nic) -and ( 'NetworkAdapterImpl' -eq $nic.GetType().Name ) )
				{
					Log-Debug -fn $fn -msg ( 'Nic successfully created: {0}' -f $nic.Name )
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Set-VirtualMachineNetworkConfiguration; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDNJ8/XjmF1CnQoWX6EtORmeY
# I4CgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSMCR6MghpaAyr2zoPC
# 1qCqJliaGDANBgkqhkiG9w0BAQEFAASCAQCaPdbdFDB2ptCNLNUfjKPXubTQqoCE
# eP8/tOk/xtuwXwwUmOXf1BN76jWd9deLluV1KU0/5T5w2bB+u50JeK8kepG9z4zr
# 43qd+dCdH38IlWnQ3PiqiVJGxtyWLD9CHBfAHZRhCKVTaxzZzv/jN6poqbuUG0VX
# hOjB2iKgZCjxhyNFEz+CjSI7q6zlreNPzxP61cDsFDfI/fCxeQBxH3WWhnWPlvP1
# hlxM+ZIujtQTdC1vQoIz0+SA1Io4jc8zZW9ADHwyIu6i5Q6fTwmG1Yj5SY8x96ej
# Nvp1lg7qJLmzmSeVGU/OhLofbmOT539kRM/eGvs3FBUqsEybkg4LdSzaoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA2NTcxMFowIwYJKoZIhvcNAQkEMRYEFP1pDGOJWvjAVfMprqixdNqijr3CMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBI036IurUjhyVUfoEoKKLw
# XhapQJOFaA5gzEL+NBwwxp8tazbT3MgGHnAo08dhCam9fUtVbE/QdMTheXPMmP9X
# 331jlvi+6Dl0BrOXhGZjfnwE/7rrg3uNVtlCoNNZz8FbBtemEH1ViNH52AcGVl6I
# Wq/UHVWf452JGcoJLD2o70b99bxpQuK45wJ3E6H4Mw8HolT765qx+UI6QhuuEgYj
# N2fS3Pd1gAWIMWWjnLa4YijJxMXuvlxaAGVyib9Fwv+7grhfVuN5lyjmSz+1Vyyi
# rNJPeHxiNxWi5yGie8I5QIxOJgAuPPC+w3a1yDqDEYK8KL/tAvg5/GpDBA1l3Cn5
