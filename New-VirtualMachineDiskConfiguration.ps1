...
Online Version: http://dfch.biz/PS/Cumulus/VI/New-VirtualMachineDiskConfiguration
...
try
{
	...
	$DiskConfig = @{};
	$DiskConfig.DatastoreName = $DatastoreName;
	$DiskConfig.CapacityMB = $CapacityMB
	$DiskConfig.StorageFormat = $StorageFormat;
	$DiskConfig.ControllerType = $ControllerType;
	$DiskConfig.UnitID = $UnitID;
	$DiskConfig.Type = $Type; 
	$DiskConfig.Persistence = $Persistence;
	$DiskConfig.AdvancedOptions = $AdvancedOptions;
}
catch
{
	$DiskConfig = $null;
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function New-VirtualMachineDiskConfiguration; } 


# SIG # Begin signature block
# MIIW3AYJKoZIhvcNAQcCoIIWzTCCFskCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUTLJRNz8cou4EIws/TpV8OgOX
# bRqgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRsfvLymLf61AbeBlbs
# djS8OH1iczANBgkqhkiG9w0BAQEFAASCAQC25CqVm1xFX0f82GyayTovcyw3X/YI
# hUj1teIzbB6wi2o+A/+5PkFiZLpNeLDcQt+1t9cLzM79DjhLEskaM55gnGFuo6D3
# 3bTYqaG2+2HVoDsrWYYRpL0qlBAlgtwLB8Tjm4Q0havpVL8LuirWfvSx2PHGODYp
# VDRVWV0wZYqRohizUOz99ocl7ODRBe17FfocFiZwvyGCKll7LaKHyF8fTRY7sUog
# kaBYHd+39XVIIhJLNrALZB5gQee3r8Q9qgTPGurqFQWW9BSD84ZxDmknSp3ZAvAm
# Gwlv77Da3kNB5C856rPisbIISV29ztB2JOsksqwSB1lpngRp/nS4Z+wfoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTIw
# MzA0MTQxNlowIwYJKoZIhvcNAQkEMRYEFFvIHGqy1gxEVlIgBGD5GZAAKp/zMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBXNFxBdRRZBcjWUG4TQZkO
# ZiO/Kyf0TXRxBlh/Th2hY29yZkyvYa+qvHeI4fJs0L7UOEOpbEE/H2u6fGPDMOB/
# g94BrXgkUAIlaxGbOGxZH12kbd2noTMXSXq5aXUdmS4i8xveqFLBHSbeFrpitp0k
# GUtZWkbuHs5AvLRq99YnoN6a4PCb+k4Tu5UUmtSy5ngcQzXx/iL7ZEsu3ImOj32x
# 6ZGzlqJT8rHqcPy9BhJOOi1aACB+6gFW3M/PiQCyBADGsP54yJOoX1HDacDa80I8
# Y2EFyEZclELOu0hXOoGs66DTMb9TX9k/4ugXBvjuXzBvGdjSJGH62dYBJnIjmnEg
