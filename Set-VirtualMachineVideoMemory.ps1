Function Set-VirtualMachineVideoMemory {
<#
.SYNOPSIS
...
try
{
	...
	$VirtualMachineview = $VirtualMachine | Get-View
	$VideoAdapter = $VirtualMachineview.Config.Hardware.Device | Where {$_.GetType().Name -eq "VirtualMachineVideoCard"}
	...
	$Config.device.videoRamSizeInKB = $VideoMemoryMB * 1KB
	$Config.operation = "edit"
	$VirtualMachineConfigSpec.deviceChange += $Config
	$VirtualMachineview.ReconfigVM($VirtualMachineConfigSpec)
} 
catch 
{
